...
function AboutSection() {
  return (
    <section id="about" className="about-section background-dark">
      <div className="section-container ">
        <h1 className="section-heading section-heading-black">About me</h1>
        <div className="columns-2">
          <div className="card">
            <h5 className="font-white">Software Developer</h5>
            <p>
          ...
          <div className="card">
            <h5 className="font-white">Expertise</h5>
